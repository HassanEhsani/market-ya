...
const ProductList = ({ products, onAddToCart }) => {
  ...
  return (
    <div>
      ...
      <button onClick={() => navigate('/cart')}>سبد خرید</button>
      <button onClick={() => navigate('/dashboard')}>داشبورد</button>
      <button onClick={() => navigate('/favorites')}>علاقه‌مندی‌ها</button>
      <button onClick={() => navigate('/admin')}>پنل ادمین</button>
